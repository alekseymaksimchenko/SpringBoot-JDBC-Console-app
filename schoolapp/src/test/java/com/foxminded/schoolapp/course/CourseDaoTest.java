...
class CourseDaoTest {
    ...
    @BeforeEach
    void setUp() {
        course = new CourseDao(jdbcTemplate);
    ...
    void testCourseDaoShouldSave() {
        ...
        String expected = "Optional[CourseEntity [id=1, name=testName, description=testDescription]]";
        String actual = course.getByID(1).toString();
