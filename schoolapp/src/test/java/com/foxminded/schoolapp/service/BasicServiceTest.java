...
public abstract class BasicServiceTest {
    ...
    protected static final String NOT_UPDATED = "Record was NOT updated due to unknown reason";
    protected static final String NOT_DELETED = "Record was NOT deleted due to unknown reason";
